...
public final class AppConfig {
    ...
    */
    public static final String FIREBASE_WEB_API_KEY = "ADDYOURAPIKEYHERE";
    public static final String FIREBASE_DATABASE_URL = "https://APPNAMEHERE-default-rtdb.europe-west1.firebasedatabase.app";
