        ...
        new AsyncTask<Void, Void, String>() {
                ...
                try {
                    ...
                    if (refreshAfterAuthFailure(e.toString())) {
                        try {
                            ...
                            return com.hyperion.zedbook.helpers.FirebaseHelper.isAuthFailure(second.toString()) ? "AUTH_REQUIRED" : "ERR:" + second.toString();
                        }
                    }
                    return com.hyperion.zedbook.helpers.FirebaseHelper.isAuthFailure(e.toString()) ? "AUTH_REQUIRED" : "ERR:" + e.toString();
                }
            }
            protected void onPostExecute(String s) {
                ...
                if (s != null && s.startsWith("ERR:")) {
                    Toast.makeText(Profile.this, friendlyError(s), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                try {
                    ...
                    if (refreshAfterAuthFailure(message)) {
                        try {
                            ...
                            return com.hyperion.zedbook.helpers.FirebaseHelper.isAuthFailure(msg2) ? "AUTH_REQUIRED" : "ERR:" + msg2;
                        }
                    }
                    return com.hyperion.zedbook.helpers.FirebaseHelper.isAuthFailure(message) ? "AUTH_REQUIRED" : "ERR:" + message;
                }
            }
            protected void onPostExecute(String s) {
                if (isAuthRequiredResult(s)) {
